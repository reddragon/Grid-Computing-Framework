...
create_window2 (void)
{
  ...
  gtk_box_pack_start (GTK_BOX (vbox2), back, FALSE, FALSE, 0);

  g_signal_connect_after ((gpointer) window2, "destroy_event",
                          G_CALLBACK (on_window2_delete_event),
                          NULL);
  g_signal_connect_after ((gpointer) back, "clicked",
...
create_window3 (void)
{
  ...
  gtk_box_pack_start (GTK_BOX (vbox3), combobox1, FALSE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox3), refresh, FALSE, FALSE, 0);

  g_signal_connect ((gpointer) window3, "destroy_event",
                    G_CALLBACK (on_window3_destroy_event),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window3, refresh, "refresh");
